...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "tor ball") || (event.body.toLowerCase() == "bal")) {
     return api.sendMessage("~ তোমার সমস্যা কি আমূর থেকে লাগলে নিয়া নেও" "বাল বাল করো কেন বাল দিয়া কি আইসক্রিম বানাইবা😹😹", threadID);
   };

  if ((event.body.toLowerCase() == "@সবাই কলে আসো") || (event.body.toLowerCase() == "@Everyone") || (event.body.toLowerCase() == "") || (event.body.toLowerCase() == "")) {
   ...
   if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "Admin")) {
     return api.sendMessage("‎ নাই কি সমস্যা আমাকে বলো আমি আছি😺😀", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ullash ッ❤️ তাকে সবাই শান্ত নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "ai") || (event.body.toLowerCase() == "Ai")) {
     return api.sendMessage("Ai নাই আমি আছি বট😑", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস শান্ত এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@nitu") || (event.body.toLowerCase() == "@nila")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস শান্ত এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Sumaiya pagli") || (event.body.toLowerCase() == "@sumaiya Islam")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস শান্ত এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@কেউ আছো ") || (event.body.toLowerCase() == "কেউ নাই")) {
     return api.sendMessage("🥰- আমি আছি😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম কইরো না মাথা এমনিতেই গরম আছে🤬⛏️😷" "হুমম হুম করলে মন থেকে গালি আসে দিবে গালি 😒👺, threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "tomar nam ki") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_> নায়ক মান্না😺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == " কলে আসো" "call a asho") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️মুড নাই..!🙂", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage(" এটার মানে কি..?😗😗" "ভালোবাসা নামক আবলামী করতে চাইলে  ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "Kmon acho") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
     return api.sendMessage("আমি তখনই ভালো থাকি যখন আপনাকে হাসতে দেখি🤎☺️"" তোমারে দেখলে কি ভাবে ভালো থাকি দিনটাই মাটি ছি..!😒😑, threadID);
   };

   if ((event.body.toLowerCase() == "mon kharap") || (event.body.toLowerCase() == "tmr ki mon kharap")) {
     return api.sendMessage("আহ সোনা গো আমার...!🌝" "কষ্ট হচ্ছে সোনা😐🤐", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("ইগনোর😪🥱", threadID);
   };
     ...
     return api.sendMessage("কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️🍆⛏️" " আমি আসবো..!😃🏃‍♂️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "@everyone" "everyone") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("মাথায় সমস্যা ডাক্তার দেখাও..🥱" "গালি দিলাম না..😒", threadID);
   };
  mess = "{name}"
